                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="md:col-span-1 bg-gray-50 p-6 rounded-lg shadow">
                            <div class="text-center">
                                <h2 class="text-xl font-semibold mb-2">{{ $user['prenom'] }} {{ $user['nom'] }}
                                </h2>
                                @if($etudiant)
                        ...
                        <div class="md:col-span-2 bg-white p-6 rounded-lg shadow">
                            ...
                            <div class="h-[calc(100vh-400px)] overflow-y-auto border rounded-lg">
                                <img src="{{ "../../storage/app/private/cvs/" . basename($etudiant['cv']) }}"
                                     alt="CV de {{ $user['prenom'] }} {{ $user['nom'] }}" class="w-full h-auto">
                            </div>
                        </div>
                    </div>
