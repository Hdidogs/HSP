            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                <form action="{{ route('entreprise.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="adresseWeb" id="adresseWeb" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div class="mb-4">
