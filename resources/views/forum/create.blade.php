<x-app-layout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                <form action="{{ route('forum.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="mb-4">
                        <label for="created_by" class="block text-sm font-medium text-gray-700 mb-2">Créé par</label>
            ...
            <div>
                ...
                <div id="preview" class="bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="p-4">
                        ...
                        <p id="previewCreatedBy" class="text-gray-600 mb-4">Créé par: </p>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            previewCreatedBy.textContent = 'Créé par: ' + (createdByInput.value || '');
        }
