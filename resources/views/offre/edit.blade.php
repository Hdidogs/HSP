        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                <div class="p-8">
                    ...
                    <form action="{{ route('offre.update', $offre) }}" method="POST" id="offreForm" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4" required
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="Décrivez le poste en détail">{{ old('description', $offre->description) }}</textarea>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="mission" id="mission" rows="4" required
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="Décrivez les missions principales du poste">{{ old('mission', $offre->mission) }}</textarea>
                            </div>
